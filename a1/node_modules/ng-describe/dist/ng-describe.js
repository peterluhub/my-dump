...
(function setupNgDescribe(root) {
  ...
  function collectInjects(options) {
      console.log('start collectInjects');
    ...
    if (check.unemptyString(options.element) || options.exposeApi) {
      console.log('element collectInjects');
      options.inject.push('$rootScope');
  ...
  function ngDescribe(options) {
    ...
    function ngSpecs() {
          console.log('bef dependencies', dependencies);

      var dependencies = {};
          console.log('aft dependencies', dependencies);
      ...
      bdd.beforeEach(function chkAng_Mock() {
      ...
      function injectDependencies($injector) {
          //console.log('inj dependencies', dependencies);
      ...
      function setupElement(elementHtml) {
        log('created element scope with values ===', dependencies);
        try {
        ...
        log('*** after la created element scope with values ===', options.parentScope);
        var scope = dependencies.$rootScope.$new();
      ...
      if (check.unemptyString(options.element)) {
        ...
        bdd.beforeEach(function () {
            log('in=== setting up element', options.element);
